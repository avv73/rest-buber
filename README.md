# Buber Breakfast CRUD REST API
Just a simple ASP.NET REST CRUD API with EF Core. Taken from [amantinband](https://github.com/amantinband/buber-breakfast), but decided to extend it by adding EF Core as Database service.
